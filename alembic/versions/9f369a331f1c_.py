...
Revision ID: 9f369a331f1c
Revises:
Create Date: 2024-05-11 18:59:56.366617
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_departments_dept_id"),
        "departments",
        ["dept_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_departments_dept_name"),
        "departments",
        ["dept_name"],
        unique=False,
    )
    ...
    op.create_index(op.f("ix_batches_scheme"), "batches", ["scheme"], unique=False)
    op.create_table(
        "sections",
        ...
        sa.Column(
            "section",
            sa.Enum("A", "B", "C", "D", "E", name="sectionname"),
            nullable=False,
        ),
        sa.Column("num_students", sa.Integer(), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f("ix_sections_section"), "sections", ["section"], unique=False)
    op.create_index(
    ...
    op.create_index(op.f("ix_semesters_sem_id"), "semesters", ["sem_id"], unique=False)
    op.create_index(
    ...
    op.create_index(op.f("ix_students_stud_id"), "students", ["stud_id"], unique=False)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("result", sa.Enum("F", "P", "W", name="results"), nullable=False),
        sa.Column(
            "grade",
    ...
    op.create_index(op.f("ix_marks_external"), "marks", ["external"], unique=False)
    op.create_index(op.f("ix_marks_internal"), "marks", ["internal"], unique=False)
