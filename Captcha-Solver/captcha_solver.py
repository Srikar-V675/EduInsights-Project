...
def captcha_og():
    MODEL_FILENAME = "Captcha-Solver/Models/captcha_model.hdf5"
    MODEL_LABELS_FILENAME = "Captcha-Solver/Models/model_labels.dat"
    CAPTCHA_IMAGE = "Captcha-Solver/Captcha/solved.png"
